            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">                        
                        <!-- /.card-header -->                        
                            <form role="form" method="POST" action={{ url('/storePro') }}  enctype="multipart/form-data">
                              <div class="card-header">
                                <h3 class="card-title">Creat New Product</h3>
                              </div>
                              <div class="card-body">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="productName" id="productName"  placeholder="ادخل اسم المنتج" class="formbold-form-input">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form">
                            ...
                            <select class="formbold-form-input" id="occupation" name="category_id">
                                ...
                                <div>
                                    <div class="form">
                                        <label for="inputStatus">Store</label>
                                        <select class="formbold-form-input" id="occupation" name="store_id">
                                            <option selected disabled>Select one</option>
                                            @foreach ($allStores as $stors)
                                            <option value="{{$stors->id}}">{{$stors->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div>
                                    <div class="form">
                                        <label for="inputStatus">materials</label>
                                        <select class="formbold-form-input" id="occupation" name="material_id">
                                            <option selected disabled>Select one</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ProDiscreption" id="inputDescription" class="form-control" rows="4"></textarea>
                                  </div>

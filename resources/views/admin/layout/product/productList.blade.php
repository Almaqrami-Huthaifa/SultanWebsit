    ...
    @section('content')
        ...
        <section class="scroll-section" id="hoverableRows">
            <div class="card mb-5">
                <div class="card-body">
                    <div>
                        <a class="btn btn-primary col-md-2" href={{route("createPro")}}>
                            New Product
                        </a>
                    </div>
                    <br />
                            ...
                            @foreach ($product as $rowNo => $pro)
                                <tr class="tr">
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ $pro->image_path }}"  alt="IMG"/>
                                    </td>
                                    <td>
                                        <a class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1"
                                            href="{{ route('EditPro', ['id' => $pro->id]) }}" title="Edit">
                                        ...
                                        <a class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1"
                                            href="{{ route('DeletePro', ['id' => $pro->id]) }}" title="Delete">
                                            <i data-acorn-size="15">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <a class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1"
                                            href="{{ route('DetailPro', ['id' => $pro->id]) }}" title="Details">
                                            <i data-acorn-size="15">

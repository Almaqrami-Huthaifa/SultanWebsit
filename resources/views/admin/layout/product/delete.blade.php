                    ...
                    <div class="card card-danger">                        
                            ...
                            <form role="form" method="POST" action={{ route('confirmDeletePro') }}>
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="proName" id="inputName" class="form-control" value="{{$product->image_path}}" readonly>
                                </div>
                                <!--
                          <div class="form-group">
                        ...
                        -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ProPrice" id="inputSpentBudget" class="form-control"  value="{{$product->price}}" readonly>
                                </div>

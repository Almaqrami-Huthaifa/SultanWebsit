            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">                        
                        <!-- /.card-header -->                        
                            <form role="form" method="POST" action={{ url('/save_newpro') }}  enctype="multipart/form-data">
    ...
    <div class="formbold-form-wrapper">
        ...
        <form action="{{ route('storePro') }}" method="POST">
            ...
            <div>
                ...
                <select class="formbold-form-input" name="categoryName" id="occupation">
            ...
            <div class="formbold-input-flex">
                <div>
                    <label class="formbold-form-label">Select the store</label>
                    
                        <select class="formbold-form-input" name="storeName" id="occupation">
            ...
            <div class="formbold-form-file-flex">
                ...
                <input type="file" name="ProImage" id="upload" class="formbold-form-file" />
            </div>
